...
const ProfessorDashboard: React.FC = () => {
  ...
  useEffect(() => {
    const mockQuestionarios: Questionario[] = [
      {
        id: 1,
        titulo: 'Avaliação de Coordenador',
        descricao: 'Avalie o desempenho do coordenador do curso',
        dataInicio: '2024-09-01',
        dataFim: '2024-09-30',
        status: 'disponivel',
        tipoItemAvaliado: 'Coordenador',
        progresso: 0,
        avaliadores: ['Professores do Curso']
      },
      {
        id: 2,
        titulo: 'Avaliação de Alunos - Turma A',
        descricao: 'Avalie o desempenho dos alunos da Turma A',
        dataInicio: '2024-09-01',
        dataFim: '2024-09-30',
        status: 'respondido',
        tipoItemAvaliado: 'Alunos',
        progresso: 100,
        avaliadores: ['Professores da Turma']
      },
      {
        id: 3,
        titulo: 'Avaliação de Turma - Matemática',
        descricao: 'Avalie a turma como um todo na disciplina de Matemática',
        dataInicio: '2024-09-01',
        dataFim: '2024-09-30',
        status: 'disponivel',
        tipoItemAvaliado: 'Turma',
        progresso: 0,
        avaliadores: ['Professores da Disciplina']
      },
      {
        id: 4,
        ...
        progresso: 0,
        avaliadores: ['Todos os Professores']
      }
    ];
          ...
          <VStack spacing={8} align="stretch">
            ...
            <Box>
              ...
              <Text fontSize="lg" color="gray.600">
                Aqui estão os questionários disponíveis para você responder
              </Text>
            </Box>
                      ...
                      <Card key={questionario.id} bg={cardBg} border="1px solid" borderColor={borderColor} _hover={{ shadow: 'lg' }}>
                        ...
                        <CardBody pt={0}>
                          <VStack spacing={4} align="stretch">
                            ...
                            {questionario.avaliadores && (
                              <HStack>
                                <Icon as={Users} w={4} h={4} color="gray.500" />
                                <Text fontSize="sm" color="gray.600">
                                  {questionario.avaliadores.join(', ')}
                                </Text>
                              </HStack>
                            )}
              ...
              <Card bg={cardBg} border="1px solid" borderColor={borderColor}>
                ...
                <CardBody pt={0}>
                  <VStack spacing={3} align="stretch">
                    <Text fontSize="sm" color="gray.600">
                      • Como professor, você pode avaliar coordenadores, alunos e turmas
                    </Text>
                    <Text fontSize="sm" color="gray.600">
                      • Suas respostas são confidenciais e anônimas
                    </Text>
                    <Text fontSize="sm" color="gray.600">
                      • Os questionários têm prazo de validade - responda dentro do prazo
                    </Text>
                    <Text fontSize="sm" color="gray.600">
                      • Para dúvidas, consulte o FAQ/Manual no menu lateral
                    </Text>
                  </VStack>
                </CardBody>
              </Card>
